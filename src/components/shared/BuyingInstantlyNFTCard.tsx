      ...
      <div className="mt-2 flex w-full justify-between px-4">
        <div className="flex flex-col items-start">
          ...
          <Button
            ...
            className="mt-4 h-fit w-full rounded-xl border-2 border-solid border-[#A66AFE] bg-[#A66AFE]/80 p-2 hover:bg-[#A66AFE]/60 focus:bg-[#A66AFE]/60"
          >
        ...
        <div className="flex flex-col items-end">
          ...
          <Button
            ...
            className="mt-4 h-fit w-full rounded-xl border-2 border-solid border-[#D1F608] bg-[#D1F608]/80 p-2 hover:bg-[#D1F608]/60 focus:bg-[#D1F608]/60"
          >
