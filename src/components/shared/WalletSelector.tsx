  ...
  return connected ? (
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogTrigger asChild>
        <Button className="horver:bg-secondary min-w-48 max-w-48 rounded-2xl border-2 border-[#CFF500] bg-black px-8 py-2 text-lg text-[#CFF500] hover:text-black">
          Connect a Wallet
        </Button>
      </DialogTrigger>
...
function ConnectWalletDialog({ close, ...walletSortingOptions }: ConnectWalletDialogProps) {
  ...
  const hasAptosConnectWallets = Boolean(aptosConnectWallets.length);
    ...
    <DialogContent className="max-h-screen overflow-auto">
      <AboutAptosConnect renderEducationScreen={renderEducationScreen}>
        ...
        <div className="flex flex-col gap-3 pt-3">
          ...
          {Boolean(installableWallets.length) && (
