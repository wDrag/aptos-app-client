...
const HomePage = () => {
  ...
  return (
    <div className="w-full bg-[url('/bg.png')] bg-repeat px-32 pt-32 text-lg">
      <div className="">
        <div className="grid grid-cols-5 items-center gap-8 ">
          <div className="col-span-3 text-white">
            <h1 className="my-1 text-[80px] font-semibold leading-[95px]">
              The pioneer <span className="tracking-wider text-primary">NFT</span>
            </h1>
            <h5 className="my-1 text-[60px] leading-[76px]">lending protocol in Aptos</h5>
            <p className="text-[32px] font-light">Effortless NFT Access, Infinite Opportunities</p>
          </div>
      ...
      <div className="my-4 mt-20 flex items-start justify-center gap-24 rounded-xl bg-card px-16 py-8 text-center text-2xl text-white">
      ...
      <div className="py-24 text-2xl text-white">
        ...
        <div className="px-24 py-12">
          ...
          <div className="mt-12 grid grid-cols-3 gap-12">
            ...
            <div className="col-span-1">
              ...
              <p className="text-lg">Rapid price fluctuations increase the risk for NFT holders.</p>
            </div>
            <div className="col-span-1">
        ...
        <div className="px-24 py-12">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 px-24 text-xl font-normal text-white">
